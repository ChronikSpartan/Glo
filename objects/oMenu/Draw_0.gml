...
{
<<<<<<< HEAD
	draw_text(room_width/2, (room_height/1.8) + (m * space), string(menu[m]));
}
	
selectorX = (room_width/2) - 128;
selectorY = (room_height/1.8) + 18 + (menuPos * space);
=======
	draw_text(room_width/2, (room_height/1.7) + (m * space), string(menu[m]));
}
...
draw_text(150, 10, "Deaths: " + string(totalDeaths));
draw_text(1050, 10, "Toggle Fullscreen: Alt + Enter");
